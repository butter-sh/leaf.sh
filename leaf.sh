...
${GREEN}EXAMPLES:${NC}
    ...
    ${CYAN}# Generate landing with custom projects${NC}
...
show_version() {
    cat << EOF
${CYAN}leaf.sh${NC} version ${GREEN}2.1.0${NC}
...
generate_landing_page() {
    ...
    local projects="${PROJECTS_JSON:-$projects_default}"
...
main() {
    ...
    echo "╔═══════════════════════════════════════════╗"
    echo "║                                           ║"
    echo "║      🌿 leaf.sh Generator v2.1 🌿        ║"
    echo "║                                           ║"
    echo "║    Beautiful docs & landing pages        ║"
    echo "║         Powered by yq parser             ║"
    echo "║                                           ║"
    echo "╚═══════════════════════════════════════════╝"
    echo -e "${NC}"
    echo
